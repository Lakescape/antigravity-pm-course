...
Generic writing, inconsistent terminology (mixes "Workspace" and "Project"), no persona references, could be any company's announcement, save as product-update-baseline.md
...
**USER: Reports seeing course-instructor.md and taskflow-context.md (Note: taskflow-terminology.md won't be there yet - they'll create it later in this module!)**
...
Terminology section: "Workspace" not "Project", "Task" not "To-do", etc. Personas section: Reference Sarah (Enterprise Admin), Mike (IC Engineer), Alex (Team Lead). Writing style: Active voice, Oxford commas, no emojis, conversational but professional. Output preferences: Use real names in examples, include specific use cases.
...
Uses "Workspace" consistently throughout, references Sarah, Mike, and/or Alex with realistic use cases, matches the TaskFlow writing style (active voice, conversational, professional), feels like it came from someone who KNOWS the product, save as product-update-with-rules.md
...
Project rules: What you just created - stored in .agent/rules/ in THIS project folder. Only apply to this project. Great for company/product-specific context. Example: TaskFlow terminology, personas, product details.

Global rules: Stored in Antigravity's settings (we're not using these in the course). Apply to ALL projects you work on. Great for personal preferences that cross projects. Example: Your writing style, how you like PRDs formatted, preferred meeting note structure.
...
Let me recap everything you've learned: Module 1.1: Welcome to TaskFlow - introduction to the course. Module 1.2: Interface basics - how to navigate Antigravity's Editor view. Module 1.3: First tasks - @mentions and file references. Module 1.4: Templates & workflows - using and refining template documents. Module 1.5: Planning Mode & image generation - upfront planning and creating visuals. Module 1.6 (this one): Project rules - persistent context that makes everything better.
...
**STOP: Type this: "Generate a fun celebratory image of someone who just became a Full Stack PM - they should look proud and accomplished, and there should be pancakes involved somehow. Make it colorful and joyful!"**

**USER: Types the prompt**

---

**ACTION: Generate a celebratory image with:**
A person looking proud/accomplished, pancakes incorporated somehow (could be stacked like achievements, being celebrated with, etc.), colorful, joyful aesthetic, Full Stack PM celebration vibes

---

Look at that! You just generated a celebration image for completing Module 1!

You're officially on your way to becoming a Full Stack PM

Save that image - you earned it!
